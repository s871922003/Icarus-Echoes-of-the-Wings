...
{	
	...
	public class InputManager : MMSingleton<InputManager>
	{
        ...
        /// the button for companion switch
        public virtual MMInput.IMButton CompanionActiveSwitch { get; protected set; }

        /// the button for command companion to do mark action
        public virtual MMInput.IMButton CompanionCommandMark { get; protected set; }

		public virtual MMInput.IMButton CompanionCommandMountToggle { get; protected set; }
